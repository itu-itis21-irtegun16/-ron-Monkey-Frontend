<template>
    <v-card class="muscle-groups" justify="center" :style="[!isDesktop ? {'width': '90%'} : {'padding-left' : '45px'}]">
        ...
        <input type="checkbox" @click="deneme" v-model="getMuscleFilters.deltoids" :style="[!isDesktop ? {'margin-left': '35px'} : {}]" class="deltoids muscles-helper" id="deltoids"> <label for="deltoids">Deltoids</label>
        <br v-if="!isDesktop">
...
export default {
    ...
    computed : {
    ...mapGetters(['getMuscleFilters'])
    },
    methods : {
    ...mapMutations(['updateMuscleFilters']),
      saveFilter(){
