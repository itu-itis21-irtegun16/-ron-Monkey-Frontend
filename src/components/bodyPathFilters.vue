<template>
    <v-card class="muscle-groups" justify="center" :style="[!isDesktop ? {'width': '90%'} : {'padding-left' : '45px'}]">
        ...
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn @click="saveFilter">Save Filters</v-btn>
        </v-card-actions>
...
export default {
    ...
    computed : {
    ...mapGetters({
        getMuscleFilters : 'getMuscleFilters'
        })
    },
    methods : {
    ...mapMutations(['updateMuscleFilters','updateFilterDialog']),
        saveFilter(){
            this.muscleArray.forEach(element =>{
                var domElement = document.getElementById(element);
                if(domElement.checked) this.getMuscleFilters[element] = true;
                else this.getMuscleFilters[element] = false;
            })
            this.updateMuscleFilters(this.getMuscleFilters);
